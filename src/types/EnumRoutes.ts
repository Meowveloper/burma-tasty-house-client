export enum EnumUserRoutes {
    ...
    PeopleYouFollowRecipes = "/people-you-followed-recipes",
    PeopleYouFollowed = "/people-you-followed",
...
export enum EnumAdminRoutes {
    ...
    ReportDetail_WithId = "/admin/report-detail/:id",
    ReportDetail = "/admin/report-detail",
}
